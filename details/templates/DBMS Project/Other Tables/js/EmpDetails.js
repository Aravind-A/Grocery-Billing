var table = document.querySelector('table'), 
    ...
    data = [
  { 'empID': 'Scooby', 'name': 'Doo', 'shift': 1969 }, 
  { 'empID': 'Yogi', 'name': 'Bear', 'shift': 1958 }, 
  { 'empID': 'Tom', 'name': 'Cat', 'shift': 1940 }, 
  { 'empID': 'Jerry', 'name': 'Mouse', 'shift': 1940 }, 
  { 'empID': 'Fred', 'name': 'Flintstone', 'shift': 1960 }
], n = data.length;
